...
class AdminNetworksTestJSON(base.BaseDvsAdminNetworkTest):
    ...
    def test_create_update_delete_network_subnet(self):
        ...
        new_name = "New_subnet"
        body = self.admin_client.update_subnet(subnet_id, name=new_name)
        updated_subnet = body['subnet']
        self.assertEqual(updated_subnet['name'], new_name)
        # Delete subnet and network
        body = self.admin_client.delete_subnet(subnet_id)
        # Remove subnet from cleanup list
        self.subnets.pop()
        body = self.admin_client.delete_network(net_id)
        self.networks.pop()
    ...
    def test_show_network(self):
        ...
        body = self.admin_client.show_network(self.network['id'])
    ...
    def test_list_networks(self):
        ...
        body = self.admin_client.list_networks()
    ...
    def test_show_subnet(self):
        ...
        body = self.admin_client.show_subnet(self.subnet['id'])
        subnet = body['subnet']

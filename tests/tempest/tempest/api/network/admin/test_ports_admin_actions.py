...
class AdminPortsTestJSON(base.BaseDvsAdminNetworkTest):
    ...
    def test_create_update_delete_port(self):
        ...
        body = self.admin_client.create_port(network_id=network_id)
        port = body['port']
        ...
        # Verify port update
        new_name = "New_Port"
        body = self.admin_client.update_port(
            port['id'],
            name=new_name,
    ...
    def test_show_port(self):
        ...
        body = self.admin_client.show_port(self.port['id'])
        port = body['port']
    ...
    def test_list_ports_fields(self):
        ...
        body = self.admin_client.list_ports(fields=fields)
        ports = body['ports']
